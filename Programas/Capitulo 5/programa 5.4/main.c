...
int main(void)
{
    ...
    Lectura(VE1, MAX);                       /* Se llama a la función Lectura. Observa que el paso del arreglo a la función es por referencia. Sólo se debe incluir el nombre del arreglo. */
    Lectura(VE2, MAX);
...
void Lectura(int VEC[], int T)           /* La función Lectura se utiliza para leer un arreglo unidimensional de T elementos de tipo entero. */
{
    int I;
    printf("\n");
    for (I=0; I<T; I++)
...
void Imprime(int VEC[], int T)          /* La función Imprime se utiliza para imprimir un arreglo unidimensional de T elementos de tipo entero. */
{
    int I;
    for (I=0; I<T; I++)
        printf("\nVEC[%d]: %d", I+1, VEC[I]);
...
void Producto(int *X, int *Y, int *Z, int T)     /* Esta función se utiliza para calcular el producto de dos arreglos unidimensionales de T elementos de tipo entero. */
{
int I;
for(I=0; I<T; I++)
       Z[I] = X[I] * Y[I];
