#include <stdio.h>
/* Combinación de variables globales y locales, y parámetro por valor y por referencia. */
...
/* CORREGIDO: En este prototipo el primer parámeto es por valor y el segundo por referencia. */
